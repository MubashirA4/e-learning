        ...
        <div className="inner_blog">
            <div className="blog-left">
                    <div className="blog-content">
                        ...
                        <div className="blog-desc">
                            ...
                            <div className="imgs">
                                <a href="" className='research'>Research</a>
                                <a href="" className='uiux'>UI UX</a>
                            </div>
                        </div>
                    </div>
                    <div className="blog-content space">
                        ...
                        <div className="blog-desc">
                            ...
                            <div className="imgs">
                                <a href="" className='research'>Research</a>
                                <a href="" className='uiux'>UI Design</a>
                            </div>
                        </div>
                    </div>
            </div>
            <div className="blog-right">
                    ...
                    <div className="blog-desc">
                        ...
                        <div className="imgs">
                            <a href="" className='prog'>Programming</a>
                            <a href="" className='research'>Research</a>
                            <a href="" className='devel'>Developments</a>
                        </div>
                        </div>  
            </div>
        </div>
